...
export const halalDatabase: Record<string, Ingredient> = {
  ...
  'e471': {
    ...
    status: 'mashbooh',
    reason: 'Can be from animal fat (including pork) or vegetable oil — source must be confirmed',
    category: 'E-Number / Emulsifier',
    scholarNote: 'If from vegetable oil: halal. If from pork fat: haram. Request manufacturer confirmation.',
  },
  'monoglycerides': {
    name: 'Monoglycerides',
    alternateNames: ['glycerol monostearate', 'distilled monoglycerides'],
    status: 'mashbooh',
    reason: 'Fatty acid source (animal or vegetable) not specified',
    category: 'Emulsifier',
  },
  'diglycerides': {
    name: 'Diglycerides',
  ...
  'e472a': {
    ...
    alternateNames: [],
    status: 'mashbooh',
    reason: 'Esters of mono/diglycerides — animal or vegetable origin unclear',
    category: 'E-Number / Emulsifier',
  },
  'e472b': {
    ...
    alternateNames: [],
    status: 'mashbooh',
    reason: 'Fatty acid origin must be confirmed',
    category: 'E-Number / Emulsifier',
  },
  'e472c': {
  ...
  'e472e': {
    ...
    status: 'mashbooh',
    reason: 'Derived from mono/diglycerides — may be animal-derived',
    category: 'E-Number / Emulsifier',
  },
  'datem': {
    name: 'DATEM',
    ...
    status: 'mashbooh',
    reason: 'May be from animal-derived mono/diglycerides',
    category: 'Emulsifier',
  },
  'e473': {
    ...
    alternateNames: [],
    status: 'mashbooh',
    reason: 'Fatty acid source (animal or vegetable) unclear',
    category: 'E-Number / Emulsifier',
  },
  'e474': {
  ...
  'e481': {
    ...
    status: 'mashbooh',
    reason: 'Stearic acid component may be animal-derived',
    category: 'E-Number / Emulsifier',
  },
  'e482': {
  ...
  'glycerin': {
    ...
    status: 'mashbooh',
    reason: 'Source (animal fat or vegetable) must be confirmed',
    category: 'Humectant',
  ...
  'e631': {
    ...
    status: 'mashbooh',
    reason: 'Can be derived from meat, fish, or tapioca starch; source must be confirmed',
  ...
  'e635': {
    ...
    status: 'mashbooh',
    reason: 'Blend of E627 and E631 — animal source possible',
    category: 'E-Number / Flavour Enhancer',
  },
  'e627': {
    ...
    status: 'mashbooh',
    reason: 'May be derived from yeast extract, fish, or meat',
    category: 'E-Number / Flavour Enhancer',
  },
  'collagen': {
    name: 'Collagen',
  ...
  'shrimp': {
    ...
    status: 'mashbooh',
    reason: 'Halal per Shafi/Maliki/Hanbali; debated by Hanafi scholars',
    category: 'Seafood',
    scholarNote: 'Most scholars permit shrimp/prawns. Strict Hanafi view: not permissible. Follow your madhab.',
  },
  'crab': {
    name: 'Crab',
  ...
  'lobster': {
    ...
    status: 'mashbooh',
    reason: 'Permissible per Shafi/Maliki/Hanbali; debated by Hanafi scholars',
    category: 'Seafood',
  },
  'oyster': {
    name: 'Oyster',
    ...
    status: 'mashbooh',
    reason: 'Halal per Shafi/Maliki; impermissible per Hanafi (not a fish)',
    category: 'Seafood',
  },
  'squid': {
    name: 'Squid',
  ...
  'e101': {
    name: 'E101 (Riboflavin)',
    alternateNames: ['vitamin b2', 'riboflavin-5-phosphate'],
    status: 'halal',
    reason: 'Vitamin B2 from fermentation or synthetic sources',
    category: 'E-Number / Vitamin',
  },
};
