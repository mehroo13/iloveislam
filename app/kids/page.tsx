...
const GAMES: Game[] = [
  ...
  // Coming soon
  { id: 'word-builder', name: 'Arabic Word Builder', description: 'Build Arabic words from letters', icon: '🔤', href: '#', color: 'from-cyan-500 to-blue-500', difficulty: 'Medium', category: 'arabic', categoryLabel: 'Language', ageGroup: ['6-9', '10-13'], stars: 4, comingSoon: true },
  { id: 'hajj-adventure', name: 'Hajj Adventure', description: 'Interactive journey through Hajj steps', icon: '🕋', href: '#', color: 'from-stone-500 to-amber-600', difficulty: 'Medium', category: 'knowledge', categoryLabel: 'Hajj', ageGroup: ['6-9', '10-13'], stars: 5, comingSoon: true },
  { id: 'sahaba-heroes', name: 'Sahaba Heroes', description: 'Learn about the companions of the Prophet ﷺ', icon: '🌟', href: '#', color: 'from-emerald-600 to-green-500', difficulty: 'Hard', category: 'knowledge', categoryLabel: 'History', ageGroup: ['10-13'], stars: 5, comingSoon: true },
  { id: 'seerah-adventure', name: 'Seerah Adventure', description: 'Interactive timeline of the Prophet\'s ﷺ life', icon: '📖', href: '#', color: 'from-amber-600 to-yellow-500', difficulty: 'Hard', category: 'knowledge', categoryLabel: 'Seerah', ageGroup: ['10-13'], stars: 5, comingSoon: true },
  { id: 'quran-letters', name: 'Quran Letter Spot', description: 'Find Arabic letters in Quranic text', icon: '📖', href: '#', color: 'from-teal-600 to-cyan-500', difficulty: 'Medium', category: 'quran', categoryLabel: 'Quran', ageGroup: ['6-9', '10-13'], stars: 4, comingSoon: true },
  { id: 'islamic-coloring', name: 'Islamic Coloring', description: 'Color beautiful Islamic patterns and mosques', icon: '🎨', href: '#', color: 'from-pink-400 to-rose-500', difficulty: 'Easy', category: 'fun', categoryLabel: 'Art', ageGroup: ['3-5', '6-9'], stars: 2, comingSoon: true },
];
